...
-  {:.fix}**Competitive Price Analysis Report**: <!--CHAN-1460-->The [Competitive Price Analysis Report](https://docs.magento.com/m2/ee/user_guide/sales-channels/amazon/competitive-price-analysis.html) has been updated to correctly report the Buy Box and Lowest Competitor price for the closest matching listing (and condition) to the merchant's listing.
