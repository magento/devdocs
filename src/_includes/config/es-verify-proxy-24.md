...
Perform the same tasks as discussed in [Configure Magento to use a search engine]({{page.baseurl}}/config-guide/elasticsearch/configure-magento.html) *except* click **Yes** from the **Enable Elasticsearch HTTP Auth** list (for OpenSearch - **Enable OpenSearch HTTP Auth**) and enter your username and password in the provided fields.
