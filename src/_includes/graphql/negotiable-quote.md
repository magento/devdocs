...
Attribute |  Data Type | Description
--- | --- | ---
`removed_from_catalog` | [ID]| A list of product IDs the seller removed from the catalog
`removed_from_quote` | [ProductInterface] | A list of products removed from the quote by either the buyer or the seller
