...
Code sniffer will be run against every PHP version the extension is compatible with. 
...
The test will be run against all combinations of Magento version, Magento edition, and PHP version.
