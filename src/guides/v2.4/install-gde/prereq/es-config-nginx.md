...
{:.bs-callout-info}
OpenSearch support has been added in 2.4.4. OpenSearch is a compatible fork of ElasticSearch. All instructions to configure {{ site.data.var.ee }} or {{ site.data.var.ce }} to use ElasticSearch 7 apply to OpenSearch. See [Migrate ElasticSearch to OpenSearch]({{page.baseurl}}/install-gde/prereq/os-migration.html) for more information.
