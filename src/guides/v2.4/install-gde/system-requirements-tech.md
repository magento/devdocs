...
Magento recommends using PHP 7.4.
While Magento supports PHP 7.3, note that it will move to [End of Life](https://www.php.net/supported-versions.php) on 2020-12-06.
