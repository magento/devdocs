...
Complete the tasks discussed in [Prerequisites].
 ...
 {:.bs-callout-info}
See the [Safe upgrade tool section]({{page.baseurl}}/sut/sut.html) for more information on the new CLI magento tool that helps you update your magento software.
