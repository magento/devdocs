...
The search engine determines the maximum number of results that a query can return. For Elasticsearch|OpenSearch, the default value of 10000 is defined in the module's `etc/di.xml` file.
