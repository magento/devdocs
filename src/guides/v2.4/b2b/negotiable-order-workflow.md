...
The steps in this section are similar to those in the [Order processing tutorial](https://developer.adobe.com/commerce/webapi/rest/tutorials/orders/order-intro.html), except that different products are added to the cart.
...
*  [Order processing tutorial](https://developer.adobe.com/commerce/webapi/rest/tutorials/orders/order-intro.html)
