...
*  Fixed problems with the `giftRegistryUid` of the `updateGiftRegistryItems` mutation.
...
*  The `customer.orders.items.total` query now returns gift card amounts in the order total responses.
