...
*  The image resizing process now processes images marked as hidden in admin. Also added `--skip_hidden_images` option to skip hidden images during `catalog:images:resize` command processing. [GitHub-28239](https://github.com/magento/magento2/issues/28239)
