...
*  The `update/cron.php` has been removed in Magento 2.4.0, if this file exists on your installation, it can be safely removed. References to this file in crontabs should also be removed when upgrading.
