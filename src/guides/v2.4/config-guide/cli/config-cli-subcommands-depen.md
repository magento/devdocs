...
functional_areas:
  ...
  - System
  - Setup
redirect_to: https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cli/dependency-reports.html
status: migrated
---
...
-  [**Framework**](https://glossary.magento.com/framework) **dependencies:** Shows the total number of dependencies on the Magento framework by module (including the total number of framework entries for each library).
