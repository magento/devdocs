...
{:.bs-callout-info}
The AWS S3 object storage is available since the Magento 2.4.2 version only.(See: [Magento Open Source 2.4.2 Release Notes]{{page.baseurl}}/release-notes/open-source-2-4-2.html/)
