...
*  Start by selecting an icon library file - download either the [Sketch (SKETCH)]({{ site.baseurl }}/download/magento_icon_library.sketch) or [Illustrator (AI)]({{ site.baseurl }}/download/Magento-icon-library.ai) files.
