...
1. Mangento have a set of [coding stadrads]({{ page.baseurl }}/coding-standards/bk-coding-standards.html) for both back-end and front-end technologies, Do refer and follow them when needed.
1. Do not repeat a work, instead create a class or method and call them when needed.
