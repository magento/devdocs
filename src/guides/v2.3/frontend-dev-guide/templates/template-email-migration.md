...
[model]: {{ site.mage2bloburl }}/{{ site.version }}/app/code/Magento/Sales/Model/Order/Email/Sender/InvoiceSender.php
[1]: {{ site.mage2bloburl }}/{{ site.version }}/app/code/Magento/Email/Model/AbstractTemplate.php
