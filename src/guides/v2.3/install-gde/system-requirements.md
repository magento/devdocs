...
This table shows versions of third-party software dependecies that Adobe tested with speecific {{site.data.var.ee}} and {{site.data.var.ce}} releases. Adobe only supports the combination of system requirements described in the following table.
