...
The function that handles the click on the modal overlay. If `outerClickHandler` option is not specified, the [closeModal()](#modal_close) method is used for handling the click on the modal overlay.
