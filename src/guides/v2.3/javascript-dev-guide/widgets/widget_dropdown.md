...
If there is a need to customize the button and arrow, [Magento UI Library](https://magento-devdocs.github.io/magento2-ui-library/dropdowns.html) provides the ability to do this with ready-made Less mixins.
