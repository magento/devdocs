...
`Preview-Version` | A timestamp (milliseconds since January 1, 1970). Use this header to query products, categories, price rules, and other entities that are scheduled to in a campaign (staged content).
