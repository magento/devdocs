...
-  `Catalog Permissions` can be paralleed by customer groups.
...
```
If you want to use parallelization for Catalog permissions, you must set one of the available modes of dimensions for the indexer:
