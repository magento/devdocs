...
[Download Icon Library .ai file]({{ site.baseurl }}/download/Magento-icon-library.ai)
[Download Icon Library Sketch file]({{ site.baseurl }}/download/magento_icon_library.sketch)
...
*  Icons should be designed on the 300px by 300px icon grid. [Download Icon Grid .ai file]({{ site.baseurl }}/download/Magento_icon_grid_300x300.ai)
...
[Download Icon Grid .ai file]({{ site.baseurl }}/download/Magento_icon_grid_300x300.ai)
