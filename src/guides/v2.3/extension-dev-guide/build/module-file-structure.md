...
*  `ViewModel`: contains PHP model clasees as part of MVVM implementation. It allows developers to offload features and business logic from block classes into separate classes that are easier to maintain, test, and reuse.
