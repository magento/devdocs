...
*  Find the Magento REST API documentation. You can view the [static REST API documentation on devdocs](https://developer.adobe.com/commerce/webapi/rest/quick-reference/) or [generate a local API reference]({{ page.baseurl }}/rest/generate-local.html).
