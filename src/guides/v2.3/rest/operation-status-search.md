...
migrated_to: https://developer.adobe.com/commerce/webapi/rest/modules/operation-status-search/
...
*  `status` - The operation status:
   ...
   *  `4` = Open
   *  `5` = Rejected
*  `bulk_uuid` - UUID generated by an [asynchronous API request](https://developer.adobe.com/commerce/webapi/rest/asynchronous-web-endpoints.html) or [Bulk API request](https://developer.adobe.com/commerce/webapi/rest/bulk-endpoints.html).
