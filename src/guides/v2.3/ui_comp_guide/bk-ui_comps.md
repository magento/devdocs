...
*  Configured through dedicated XML file (view/adminhtml/ui_component/[ui_component_name.xml]). For example, the Customers grid UI component defined in `<Magento_Customer_module_dir>/view/adminhtml/ui_component/customer_listing.xml`.
