...
{:.bs-callout-warning}
To apply official quality patches use our [Quality Patches Tool]({{ site.baseurl }}{{ site.gdeurl }}/comp-mgr/patching/mqp.html). Always perform comprehensive testing before deploying any custom patch.
