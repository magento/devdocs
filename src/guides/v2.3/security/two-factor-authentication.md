...
The 2FA extension installs when you install or upgrade to {{site.data.var.ce}} or Commerce 2.3.X. This extensions installs like a Core Bundled Extension (CBE).
