...
**Issue**: An error message appears when a shopper attempts to change their credit card while checking out with Amazon Pay.  The shopper can successfully complete checkout by ignoring the error and proceeding to checkout. To resolve this issue and remove the error, we created a hotfix. See [Amazon Pay credit card change error](https://support.magento.com/hc/en-us/articles/360042646332) to apply the fix. <!-- BUNDLE-2554-->
