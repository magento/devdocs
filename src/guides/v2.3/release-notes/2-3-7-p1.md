...
{{ site.data.var.ee }} 2.3.7-p1 is a security release that provides 17 security fixes that enhance your Magento 2.3.7 deployment. Merchants can now install time-sensitive security fixes without applying the hundreds of functional fixes and enhancements that a full release provides. Patch 2.3.7-p1 is a security patch that provides fixes for vulnerabilities that have been identified in the previous patch release, {{ site.data.var.ee }} 2.3.7 and {{ site.data.var.ce }} 2.3.7.
