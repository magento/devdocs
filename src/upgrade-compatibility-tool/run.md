...
You can run the {{site.data.var.uct}} with a run configuration via the PHPstorm plugin. See the [Upgrade Compatibility Tool Run Configuration]({{page.baseurl}}/guides/v2.4/ext-best-practices/phpstorm/uct-run-configuration.html) topic for more information.
