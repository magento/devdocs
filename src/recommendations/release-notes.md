...
-  {:.new}Added new recommendation types: [Conversion (view to cart)]({{ site.user_guide_url }}/marketing/prex-type-convcart.html), [Conversion (view to purchase)]({{ site.user_guide_url }}/marketing/prex-type-convpurchase.html), and [Recently viewed]({{ site.user_guide_url }}/marketing/prex-type-recentview.html). Note that these new recommendation types are available in the `magento/product-recommendations` module 3.2.2 and later.
...
-  {:.new}Added support for B2B customer group pricing. When you set a [price filter on a recommendation unit]({{ site.user_guide_url }}/marketing/recommendation-incl-excl.html#filtertypes), B2B customers who are logged in will see the customer group pricing set for the products displayed.
...
-  {:.new}Renamed Magento Services to [Commerce Services]({{ site.user_guide_url }}/system/saas.html) and improved usability in the Admin
...
-  {:.new}Added the ability to [preview recommendation results]({{ site.user_guide_url }}/marketing/create-new-rec.html#preview) at creation time. This might require that you update your module to the latest version.
-  {:.new}Added the ability to [monitor and manage]({{ site.user_guide_url }}/system/catalog-sync.html) the catalog sync process from the Admin Panel
-  {:.new}Added [inclusion and exclusion filters]({{ site.user_guide_url }}/marketing/recommendation-incl-excl.html) to control what products can and cannot be displayed in recommendations
-  {:.new}Added the [Visual similarity recommendation type]({{ site.user_guide_url }}/marketing/prex-type-visualsim.html)
...
-  {:.new}Fetch Product Recommendations from alternate SaaS Data Spaces. This allows you to use product recommendations computed in your product environment on other, non-production environments. [Switching SaaS Data Spaces]({{ site.user_guide_url }}/marketing/recommendation-change-source.html) further describes this feature.
...
-  {:.new}Page Builder support. With the Page Builder integration, you can accurately and granularly place Recommendation units in any arbitrary location on Page Builder-authored content. You also can style the headings and recommendation units themselves. [Page Builder support]({{ site.user_guide_url }}/marketing/page-builder-add-product-recs.html) further describes this feature.
...
-  [User Guide]({{ site.user_guide_url }}/marketing/product-recommendations.html)
