...
--------- | ------------- |-------------| ------------
`elasticsearch` |6.x, 7.x | **Magento version 2.3.5 and later**— 5.2, 6.5, 7.2, 7.5<br>**Magento version 2.3.1 to 2.3.4**— 6.5<br>**Magento version 2.3.0**— 2.4, 5.2  | **Magento version 2.2.8 and later**— 5.2, 6.5 <br>**Magento version 2.2.0 to 2.2.7**— 5.2
`mariadb` | 10.1, 10.2, 10.3, 10.4 | **Magento version 2.3.0 to 2.3.5**–10.1 to 10.2<br> | 10.1 to 10.2
`nginx`   | | 1.9           | 1.9
...
`rabbitmq`| 3.8 | **Magento version 2.3.5**–3.8<br>**Magento version 2.3.3 - 2.3.5**— 3.7, 3.8<br>**Magento version 2.3.0 to 2.3.3**— 3.7     | 3.5
`redis`   | 5.x| **Magento version 2.3.4 - 2.3.5**–4.x, 5.x, 6.x<br>**Magento version 2.3.1 to 2.3.3**— 4.0, 5.0<br>**Magento version 2.3.0**— 3.2, 4.0 | 3.2, 4.0, 5.0
...
During the deployment process, {{site.data.var.ece}} checks installed service versions against the end-of-life (EOL) date for each service.
...
To maintain Magento store security, updata installed software versions before they reach EOL.
