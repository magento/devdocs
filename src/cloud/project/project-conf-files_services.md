...
--------- | ------------- |-------------| ------------
`elasticsearch` | 7.5.x, 7.7.x | **Magento version 2.3.5 and later**— 5.2, 6.5, 7.5, 7.7<br>**Magento version 2.3.1 to 2.3.4**— 5.2, 6.5<br>**Magento version 2.3.0**— 5.2  | **Magento version 2.2.8 and later**— 5.2, 6.5 <br>**Magento version 2.2.0 to 2.2.7**— 5.2
