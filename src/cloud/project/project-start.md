...
`/.magento/services.yaml` | Configuration file that defines a MySQL instance, Redis, and Opensearch. See [Configure environments]({{ site.baseurl }}/cloud/env/environments.html).
