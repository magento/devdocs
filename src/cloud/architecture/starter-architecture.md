...
{{site.data.var.ece}} currently supports the following services: PHP, MySQL (MariaDB), Elasticsearch ({{site.data.var.ee}} 2.2.x and later), Opensearch 2.4.4 and later, Redis, and RabbitMQ.
