...
-  {:.fix}**Errors on warmup*—Fixed an issue that attempted to warmup when the page visibility is set to `not visible individually`, resulting in `ERROR: Warming up failed: <link to page>` errors in the deployment log.<!-- MCLOUD-9134 -->
