...
| [`{{site.data.var.mcd-prod}}` release notes] | {{site.data.var.mcd-release}}              | Functionality and configuration files for Docker images to deploy Adobe Commerce to a local Cloud environment                                                                                                             | [{{site.data.var.mcd-package}}][Docker package]     |
