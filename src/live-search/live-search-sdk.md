...
The following headers are required for this API:
...
The API is unauthenticated, but requires an API key with the value set to “`search_gql`.

## GraphQL Playground

The GraphQL Playground is available from Live Search in the Magento Admin and gives you the ability to compose and test queries using actual catalog data.
