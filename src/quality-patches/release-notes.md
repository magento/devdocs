...
-  **MDVA-37478** _(for Magento `>=2.3.0 <=2.3.7`)_-Fixes the issue where Magento throws error when creating a partial invoice for order placed with payment method "Payment on Account" through REST API.
