...
![]({% link images/images/sellers/account-information.png %}){: .zoom}
...
1. In the Basic Access Key Information dialog, enter an **Access Key Name** (max of 32 characters) to identify the access key. Then, click <span class="btn">Continue</span>.
    ...
    ![]({% link images/images/sellers/basic-access-key-information.png %}){: .zoom}
...
![]({% link images/images/sellers/access-keys.png %}){: .zoom}
...
![]({% link images/images/sellers/marketplace-profile.png %}){: .zoom}
...
![]({% link images/images/sellers/tax-forms.png %}){: .zoom}
_Tax Forms_
...
![]({% link images/images/sellers/partner-portal.png %}){: .zoom}
_Partner Portal_
