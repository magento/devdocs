...
You can install Magento Enterprise Edition 2.1 using Composer. 
...
## Install using Composer {#install-rc-composer}
The Magento software is available from `repo.magento.com`. Before installing using Composer, familiarize yourself with these  <a href="{{ site.gdeurl }}install-gde/prereq/integrator_install.html" target="_blank">prerequisites</a>, then run:
