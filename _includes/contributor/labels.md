...
* `Technical` - Updates to the code or processes that alter the technical content of the document such as code snippets, reference documentation, parameter names and values, and so on
