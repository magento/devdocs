...
To help export Production data as test data to use in Staging and Development (Integration) environments, [Run the support utilities]({{ page.baseurl }}config-guide/cli/config-cli-subcommands-spt-util.html):
