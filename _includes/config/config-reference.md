...
Access Restriction | `general/restriction/is_active` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Restriction Mode | `general/restriction/mode` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Startup Page | `general/restriction/http_redirect` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Landing Page | `general/restriction/cms_page` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
HTTP Response | `general/restriction/http_status` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Default Product Price | `catalog/price/default_product_price` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Search Suggestions | `catalog/search/search_suggestion_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Search Suggestions Count | `catalog/search/search_suggestion_count` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Results Count for Each Suggestion | `catalog/search/search_suggestion_count_results_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable Search Recommendations | `catalog/search/search_recommendations_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Search Recommendations Count | `catalog/search/search_recommendations_count` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Results Count for Each Recommendation | `catalog/search/search_recommendations_count_results_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable | `catalog/magento_catalogpermissions/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Browsing Category | `catalog/magento_catalogpermissions/grant_catalog_category_view` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_catalog_category_view_groups` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Landing Page | `catalog/magento_catalogpermissions/restricted_landing_page` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Display Product Prices | `catalog/magento_catalogpermissions/grant_catalog_product_price` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_catalog_product_price_groups` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Adding to Cart | `catalog/magento_catalogpermissions/grant_checkout_items` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_checkout_items_groups` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Disallow Catalog Search By | `catalog/magento_catalogpermissions/deny_catalog_search` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Catalog Events Functionality | `catalog/magento_catalogevent/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable Catalog Event Widget on Storefront | `catalog/magento_catalogevent/lister_output` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Number of Events to be Displayed in Event Slider Widget | `catalog/magento_catalogevent/lister_widget_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Events to Scroll per Click in Event Slider Widget | `catalog/magento_catalogevent/lister_widget_scroll` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Maximum Number of Products in Related Products List | `catalog/magento_targetrule/related_position_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Related Products | `catalog/magento_targetrule/related_position_behavior` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Rotation Mode for Products in Related Product List | `catalog/magento_targetrule/related_rotation_mode` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Maximum Number of Products in Cross-Sell Product List | `catalog/magento_targetrule/crosssell_position_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Cross-Sell Products | `catalog/magento_targetrule/crosssell_position_behavior` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Rotation Mode for Products in Cross-Sell Product List | `catalog/magento_targetrule/crosssell_rotation_mode` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Maximum Number of Products in Upsell Product List | `catalog/magento_targetrule/upsell_position_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Upsell Products | `catalog/magento_targetrule/upsell_position_behavior` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Rotation Mode for Products in Upsell Product List | `catalog/magento_targetrule/upsell_rotation_mode` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Use deferred Stock update | `cataloginventory/item_options/use_deferred_stock_update` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Visible Attributes for Category Rules | `visualmerchandiser/options/smart_attributes` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Minimum Stock Threshold | `visualmerchandiser/options/minimum_stock_threshold` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Color Attribute Code | `visualmerchandiser/options/color_attribute_code` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Color Order | `visualmerchandiser/options/color_order` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Store Credit Functionality | `customer/magento_customerbalance/is_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Show Store Credit History to Customers | `customer/magento_customerbalance/show_history` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Refund Store Credit Automatically | `customer/magento_customerbalance/refund_automatically` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Store Credit Update Email Sender | `customer/magento_customerbalance/email_identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Store Credit Update Email Template | `customer/magento_customerbalance/email_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Customer Segment Functionality | `customer/magento_customersegment/is_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Multiple Wish Lists | `wishlist/general/multiple_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Number of Multiple Wish Lists | `wishlist/general/multiple_wishlist_number` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Enable Invitations Functionality | `magento_invitation/general/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable Invitations on Storefront | `magento_invitation/general/enabled_on_front` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Referred Customer Group | `magento_invitation/general/registration_use_inviter_group` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
New Accounts Registration | `magento_invitation/general/registration_required_invitation` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Customers to Add Custom Message to Invitation Email | `magento_invitation/general/allow_customer_message` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Max Invitations Allowed to be Sent at One Time | `magento_invitation/general/max_invitation_amount_per_send` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Invitation Email Sender | `magento_invitation/email/identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Invitation Email Template | `magento_invitation/email/template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Enable Reward Points Functionality | `magento_reward/general/is_enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable Reward Points Functionality on Storefront | `magento_reward/general/is_enabled_on_front` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customers May See Reward Points History | `magento_reward/general/publish_history` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Rewards Points Balance Redemption Threshold | `magento_reward/general/min_points_balance` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Cap Reward Points Balance At | `magento_reward/general/max_points_balance` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Reward Points Expire in (days) | `magento_reward/general/expiration_days` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Reward Points Expiry Calculation | `magento_reward/general/expiry_calculation` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Refund Reward Points Automatically | `magento_reward/general/refund_automatically` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Deduct Reward Points from Refund Amount Automatically | `magento_reward/general/deduct_automatically` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Landing Page | `magento_reward/general/landing_page` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Purchase | `magento_reward/points/order` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Registration | `magento_reward/points/register` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Newsletter Signup | `magento_reward/points/newsletter` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Converting Invitation to Customer | `magento_reward/points/invitation_customer` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Invitation to Customer Conversions Quantity Limit | `magento_reward/points/invitation_customer_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Converting Invitation to Order | `magento_reward/points/invitation_order` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Invitation to Order Conversions Quantity Limit | `magento_reward/points/invitation_order_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Invitation Conversion to Order Reward | `magento_reward/points/invitation_order_frequency` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Review Submission | `magento_reward/points/review` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Rewarded Reviews Submission Quantity Limit | `magento_reward/points/review_limit` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Email Sender | `magento_reward/notification/email_sender` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Subscribe Customers by Default | `magento_reward/notification/subscribe_by_default` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Balance Update Email | `magento_reward/notification/balance_update_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Reward Points Expiry Warning Email | `magento_reward/notification/expiry_warning_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Expiry Warning Before (days) | `magento_reward/notification/expiry_day_before` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Gift Cards | `sales/totals_sort/giftcardaccount` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Store Credit | `sales/totals_sort/customerbalance` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Allow Gift Wrapping on Order Level | `sales/gift_options/wrapping_allow_order` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Gift Wrapping for Order Items | `sales/gift_options/wrapping_allow_items` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Gift Receipt | `sales/gift_options/allow_gift_receipt` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Allow Printed Card | `sales/gift_options/allow_printed_card` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Default Price for Printed Card | `sales/gift_options/printed_card_price` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enable Order by SKU on My Account in Storefront | `sales/product_sku/my_account_enable` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Customer Groups | `sales/product_sku/allowed_groups` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable Archiving | `sales/magento_salesarchive/active` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Archive Orders Purchased | `sales/magento_salesarchive/age` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Order Statuses to be Archived | `sales/magento_salesarchive/order_statuses` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable RMA on Storefront | `sales/magento_rma/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enable RMA on Product Level | `sales/magento_rma/enabled_on_product` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Use Store Address | `sales/magento_rma/use_store_address` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enabled | `sales_email/magento_rma/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Email Sender | `sales_email/magento_rma/identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Email Template | `sales_email/magento_rma/template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Email Template for Guest | `sales_email/magento_rma/guest_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Send RMA Email Copy Method | `sales_email/magento_rma/copy_method` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enabled | `sales_email/magento_rma_auth/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Authorization Email Sender | `sales_email/magento_rma_auth/identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Authorization Email Template | `sales_email/magento_rma_auth/template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Authorization Email Template for Guest | `sales_email/magento_rma_auth/guest_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Send RMA Authorization Email Copy Method | `sales_email/magento_rma_auth/copy_method` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enabled | `sales_email/magento_rma_comment/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Sender | `sales_email/magento_rma_comment/identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Template | `sales_email/magento_rma_comment/template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Template for Guest | `sales_email/magento_rma_comment/guest_template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Send RMA Email Copy Method | `sales_email/magento_rma_comment/copy_method` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Enabled | `sales_email/magento_rma_customer_comment/enabled` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Sender | `sales_email/magento_rma_customer_comment/identity` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Recipient | `sales_email/magento_rma_customer_comment/recipient` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
RMA Comment Email Template | `sales_email/magento_rma_customer_comment/template` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Send RMA Email Copy Method | `sales_email/magento_rma_customer_comment/copy_method` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Tax Class for Gift Options | `tax/classes/wrapping_tax_class` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Display Gift Wrapping Prices | `tax/cart_display/gift_wrapping` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Display Printed Card Prices | `tax/cart_display/printed_card` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Display Gift Wrapping Prices | `tax/sales_display/gift_wrapping` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
Display Printed Card Prices | `tax/sales_display/printed_card` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Preview Quote Lifetime (minutes) | `checkout/cart/preview_quota_lifetime` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enabled for RMA | `carriers/ups/active_rma` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enabled for RMA | `carriers/usps/active_rma` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enabled for RMA | `carriers/fedex/active_rma` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Enabled for RMA | `carriers/dhl/active_rma` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
Account type | `google/analytics/type` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
...
List property for the catalog page | `google/analytics/catalog_page_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
List property for the cross-sell block | `google/analytics/crosssell_block_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
List property for the up-sell block | `google/analytics/upsell_block_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
List property for the related products block | `google/analytics/related_block_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
List property for the search results page | `google/analytics/search_page_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
’Internal Promotions’ for promotions field “Label”. | `google/analytics/promotions_list_value` | ![Not EE-only]({{ site.baseurl }}common/images/red-x.png)
