...
HTTP Response | `general/restriction/http_status` | ![Not EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Default Product Price | `catalog/price/default_product_price` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Search Suggestions | `catalog/search/search_suggestion_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Search Suggestions Count | `catalog/search/search_suggestion_count` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Results Count for Each Suggestion | `catalog/search/search_suggestion_count_results_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable Search Recommendations | `catalog/search/search_recommendations_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Search Recommendations Count | `catalog/search/search_recommendations_count` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Results Count for Each Recommendation | `catalog/search/search_recommendations_count_results_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable | `catalog/magento_catalogpermissions/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Browsing Category | `catalog/magento_catalogpermissions/grant_catalog_category_view` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_catalog_category_view_groups` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Landing Page | `catalog/magento_catalogpermissions/restricted_landing_page` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Display Product Prices | `catalog/magento_catalogpermissions/grant_catalog_product_price` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_catalog_product_price_groups` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Adding to Cart | `catalog/magento_catalogpermissions/grant_checkout_items` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Groups | `catalog/magento_catalogpermissions/grant_checkout_items_groups` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Disallow Catalog Search By | `catalog/magento_catalogpermissions/deny_catalog_search` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Catalog Events Functionality | `catalog/magento_catalogevent/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable Catalog Event Widget on Storefront | `catalog/magento_catalogevent/lister_output` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Number of Events to be Displayed in Event Slider Widget | `catalog/magento_catalogevent/lister_widget_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Events to Scroll per Click in Event Slider Widget | `catalog/magento_catalogevent/lister_widget_scroll` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Maximum Number of Products in Related Products List | `catalog/magento_targetrule/related_position_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Related Products | `catalog/magento_targetrule/related_position_behavior` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Rotation Mode for Products in Related Product List | `catalog/magento_targetrule/related_rotation_mode` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Maximum Number of Products in Cross-Sell Product List | `catalog/magento_targetrule/crosssell_position_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Cross-Sell Products | `catalog/magento_targetrule/crosssell_position_behavior` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Rotation Mode for Products in Cross-Sell Product List | `catalog/magento_targetrule/crosssell_rotation_mode` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Maximum Number of Products in Upsell Product List | `catalog/magento_targetrule/upsell_position_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Upsell Products | `catalog/magento_targetrule/upsell_position_behavior` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Rotation Mode for Products in Upsell Product List | `catalog/magento_targetrule/upsell_rotation_mode` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Use deferred Stock update | `cataloginventory/item_options/use_deferred_stock_update` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Visible Attributes for Category Rules | `visualmerchandiser/options/smart_attributes` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Minimum Stock Threshold | `visualmerchandiser/options/minimum_stock_threshold` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Color Attribute Code | `visualmerchandiser/options/color_attribute_code` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Color Order | `visualmerchandiser/options/color_order` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Store Credit Functionality | `customer/magento_customerbalance/is_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Show Store Credit History to Customers | `customer/magento_customerbalance/show_history` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Refund Store Credit Automatically | `customer/magento_customerbalance/refund_automatically` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Store Credit Update Email Sender | `customer/magento_customerbalance/email_identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Store Credit Update Email Template | `customer/magento_customerbalance/email_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Customer Segment Functionality | `customer/magento_customersegment/is_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Multiple Wish Lists | `wishlist/general/multiple_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Number of Multiple Wish Lists | `wishlist/general/multiple_wishlist_number` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Enable Invitations Functionality | `magento_invitation/general/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable Invitations on Storefront | `magento_invitation/general/enabled_on_front` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Referred Customer Group | `magento_invitation/general/registration_use_inviter_group` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
New Accounts Registration | `magento_invitation/general/registration_required_invitation` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Customers to Add Custom Message to Invitation Email | `magento_invitation/general/allow_customer_message` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Max Invitations Allowed to be Sent at One Time | `magento_invitation/general/max_invitation_amount_per_send` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Invitation Email Sender | `magento_invitation/email/identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Invitation Email Template | `magento_invitation/email/template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Name  | Config path | EE only?
|--------------|--------------|--------------|
Enable Reward Points Functionality | `magento_reward/general/is_enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable Reward Points Functionality on Storefront | `magento_reward/general/is_enabled_on_front` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customers May See Reward Points History | `magento_reward/general/publish_history` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Rewards Points Balance Redemption Threshold | `magento_reward/general/min_points_balance` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Cap Reward Points Balance At | `magento_reward/general/max_points_balance` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Reward Points Expire in (days) | `magento_reward/general/expiration_days` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Reward Points Expiry Calculation | `magento_reward/general/expiry_calculation` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Refund Reward Points Automatically | `magento_reward/general/refund_automatically` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Deduct Reward Points from Refund Amount Automatically | `magento_reward/general/deduct_automatically` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Landing Page | `magento_reward/general/landing_page` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Purchase | `magento_reward/points/order` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Registration | `magento_reward/points/register` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Newsletter Signup | `magento_reward/points/newsletter` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Converting Invitation to Customer | `magento_reward/points/invitation_customer` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Invitation to Customer Conversions Quantity Limit | `magento_reward/points/invitation_customer_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Converting Invitation to Order | `magento_reward/points/invitation_order` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Invitation to Order Conversions Quantity Limit | `magento_reward/points/invitation_order_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Invitation Conversion to Order Reward | `magento_reward/points/invitation_order_frequency` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Review Submission | `magento_reward/points/review` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Rewarded Reviews Submission Quantity Limit | `magento_reward/points/review_limit` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Email Sender | `magento_reward/notification/email_sender` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Subscribe Customers by Default | `magento_reward/notification/subscribe_by_default` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Balance Update Email | `magento_reward/notification/balance_update_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Reward Points Expiry Warning Email | `magento_reward/notification/expiry_warning_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Expiry Warning Before (days) | `magento_reward/notification/expiry_day_before` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Gift Cards | `sales/totals_sort/giftcardaccount` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Store Credit | `sales/totals_sort/customerbalance` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Allow Gift Wrapping on Order Level | `sales/gift_options/wrapping_allow_order` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Gift Wrapping for Order Items | `sales/gift_options/wrapping_allow_items` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Gift Receipt | `sales/gift_options/allow_gift_receipt` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Allow Printed Card | `sales/gift_options/allow_printed_card` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Default Price for Printed Card | `sales/gift_options/printed_card_price` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enable Order by SKU on My Account in Storefront | `sales/product_sku/my_account_enable` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Customer Groups | `sales/product_sku/allowed_groups` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable Archiving | `sales/magento_salesarchive/active` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Archive Orders Purchased | `sales/magento_salesarchive/age` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Order Statuses to be Archived | `sales/magento_salesarchive/order_statuses` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable RMA on Storefront | `sales/magento_rma/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enable RMA on Product Level | `sales/magento_rma/enabled_on_product` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Use Store Address | `sales/magento_rma/use_store_address` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enabled | `sales_email/magento_rma/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Email Sender | `sales_email/magento_rma/identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Email Template | `sales_email/magento_rma/template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Email Template for Guest | `sales_email/magento_rma/guest_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Send RMA Email Copy Method | `sales_email/magento_rma/copy_method` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enabled | `sales_email/magento_rma_auth/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Authorization Email Sender | `sales_email/magento_rma_auth/identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Authorization Email Template | `sales_email/magento_rma_auth/template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Authorization Email Template for Guest | `sales_email/magento_rma_auth/guest_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Send RMA Authorization Email Copy Method | `sales_email/magento_rma_auth/copy_method` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enabled | `sales_email/magento_rma_comment/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Sender | `sales_email/magento_rma_comment/identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Template | `sales_email/magento_rma_comment/template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Template for Guest | `sales_email/magento_rma_comment/guest_template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Send RMA Email Copy Method | `sales_email/magento_rma_comment/copy_method` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Enabled | `sales_email/magento_rma_customer_comment/enabled` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Sender | `sales_email/magento_rma_customer_comment/identity` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Recipient | `sales_email/magento_rma_customer_comment/recipient` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
RMA Comment Email Template | `sales_email/magento_rma_customer_comment/template` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Send RMA Email Copy Method | `sales_email/magento_rma_customer_comment/copy_method` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Tax Class for Gift Options | `tax/classes/wrapping_tax_class` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Display Gift Wrapping Prices | `tax/cart_display/gift_wrapping` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Display Printed Card Prices | `tax/cart_display/printed_card` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Display Gift Wrapping Prices | `tax/sales_display/gift_wrapping` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
Display Printed Card Prices | `tax/sales_display/printed_card` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Preview Quote Lifetime (minutes) | `checkout/cart/preview_quota_lifetime` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enabled for RMA | `carriers/ups/active_rma` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enabled for RMA | `carriers/usps/active_rma` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enabled for RMA | `carriers/fedex/active_rma` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Enabled for RMA | `carriers/dhl/active_rma` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
Account type | `google/analytics/type` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
...
List property for the catalog page | `google/analytics/catalog_page_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
List property for the cross-sell block | `google/analytics/crosssell_block_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
List property for the up-sell block | `google/analytics/upsell_block_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
List property for the related products block | `google/analytics/related_block_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
List property for the search results page | `google/analytics/search_page_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
’Internal Promotions’ for promotions field “Label”. | `google/analytics/promotions_list_value` | ![EE-only]({{ site.baseurl }}common/images/green-check.png)
