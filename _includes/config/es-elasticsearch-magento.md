...
Elasticsearch 2.x is not compatible with Magento 2.3.1 module.
If you must run Elasticsearch 2.x with Magento 2.3.1, you must downgrade the Elasticsearch.
Follow the instructions in [Downgrade Elasticsearch Module]({{page.baseurl}}/config-guide/elasticsearch/es-downgrade.html).
