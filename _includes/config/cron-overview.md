...
We recommend you run cron as the <a href="{{page.baseurl}}install-gde/prereq/file-sys-perms-over.html">Magento file system owner</a>. Do *not* run cron as `root`; we also recommend against running cron as the web server user.
