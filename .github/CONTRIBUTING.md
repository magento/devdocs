...
-  Do not make changes to content in the [`_data/codebase`](https://src/_data/codebase) directory, which contains version-specific, auto-generated content from Magento source code. Any manual changes will be lost when the file regenerates.
