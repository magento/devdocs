...
<div class="bs-callout bs-callout-info" id="info">
  <p>The default configuration is set in [<code>&lt;magento2&gt;/dev/tests/functional/etc/config.xml.dist</code>]({{ site.mage2000url }}dev/tests/functional/etc/config.xml.dist). It should be copied as <code>config.xml</code> for further changes.</p>
</div>
