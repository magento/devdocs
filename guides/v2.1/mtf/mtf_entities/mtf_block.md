...
In functional tests we use Page Object Design Pattern. Under this pattern, a block is an area of the UI that a test interacts with, and a [page]({{site.gdeurl21}}mtf/mtf_entities/mtf_page.html) is a container for blocks.
...
**Step 1**. Create `Bundle/Test/Page/Product/CatalogProductView.xml` page to merge with the basic page `Catalog/Test/Page/Product/CatalogProductView.xml`. [Learn more about page merging]({{site.gdeurl21}}mtf/mtf_entities/mtf_page.html#mtf_page_merge).
