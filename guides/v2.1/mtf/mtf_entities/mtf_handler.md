...
|WebAPI|Sends a POST request using the REST API. <a href="{{site.gdeurl21}}rest/bk-rest.html">See REST API reference documentation.</a> |Similar to cURL but uses the REST API entry point. |Has the advantage of testing the API, faster than cURL.|
