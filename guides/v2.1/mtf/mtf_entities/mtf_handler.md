...
The default configuration for handlers is set in [`<magento2>/dev/tests/functional/etc/config.xml.dist`]({{ site.mage2100url }}dev/tests/functional/etc/config.xml.dist). 
