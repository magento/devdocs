...
<p>To work with generateFixtureXml tool, [Magento must be installed.]({{ page.baseurl }}/install-gde/bk-install-guide.html)</p>
</div>
...
[<img src="{{ site.baseurl }}/common/images/ftf/mtf_fixture_xml_pic.png" />]({{ site.baseurl }}/common/images/ftf/mtf_fixture_xml_pic.png)
