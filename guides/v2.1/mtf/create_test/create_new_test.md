...
A new PHP class `Synonym.php` is generated in `<magento2>/dev/tests/functional/generated/Magento/Search/Test/Fixture`.
...
In this example it is named `CreateSynonymEntityTest.php` and stored in `<magento2>/dev/tests/functional/tests/app/Magento/Search/Test/TestCase`.
...
Now we can add a [data set][] with variations that cover cases in the [test description][]: `<magento2>/dev/tests/functional/tests/app/Magento/Search/Test/TestCase/CreateSynonymEntityTest.xml`
...
Fortunately, this type of assertion  is commonly used in functional tests. If we search on the phrase "SuccessSaveMessage" in `<magento2>/dev/tests/functional`, there will be several matches. Let's select from the list of results a [`\Magento\Customer\Test\Constraint\AssertCustomerSuccessSaveMessage`][] class. It has the following code:
...
1) Open `<magento2>dev/tests/functional/tests/app/Magento/Search/Test/Page/Adminhtml/SynonymsIndex.xml`.
...
[install one]: {{site.gdeurl21}}install-gde/prereq/dev_install.html
...
[test case topic]: {{site.gdeurl21}}mtf/mtf_entities/mtf_testcase.html
[injectable test]: {{site.gdeurl21}}mtf/mtf_entities/mtf_testcase.html
[block]: {{site.gdeurl21}}mtf/mtf_entities/mtf_block.html
[blocks]: {{site.gdeurl21}}mtf/mtf_entities/mtf_block.html
[block mapping]: {{site.gdeurl21}}mtf/mtf_entities/mtf_block.html#mtf_block_mapping
[Learn about form mapping]: {{site.gdeurl21}}mtf/mtf_entities/mtf_block.html#mtf_block_mapping
[nodes description table]: {{site.gdeurl21}}mtf/mtf_entities/mtf_block.html#mtf_block_form_xml_nodes
[page]: {{site.gdeurl21}}mtf/mtf_entities/mtf_page.html
[pages]: {{site.gdeurl21}}mtf/mtf_entities/mtf_page.html
[Page topic]: {{site.gdeurl21}}mtf/mtf_entities/mtf_page.html
[constraint]: {{site.gdeurl21}}mtf/mtf_entities/mtf_constraint.html
[custom typified element]: {{site.gdeurl21}}mtf/mtf_entities/mtf_typified-element.html#magento_class


[adjust a configuration]: {{site.gdeurl21}}mtf/mtf_quickstart/mtf_quickstart_config.html
[prepare Magento application]: {{site.gdeurl21}}mtf/mtf_quickstart/mtf_quickstart_magento.html
[prepare environment for test run]: {{site.gdeurl21}}mtf/mtf_quickstart/mtf_quickstart_environmemt.html

[`generateFixtureXml.php`]: {{site.gdeurl21}}mtf/mtf_entities/mtf_fixture.html#mtf_fixture_create
[set data to a fixture field]: {{site.gdeurl21}}mtf/mtf_entities/mtf_dataset.html#fixture_field
[set data to a fixture field from a repository]: {{site.gdeurl21}}mtf/mtf_entities/mtf_dataset.html#fixture_field_repository
[`%isolation%` placeholder]: {{site.gdeurl21}}mtf/mtf_entities/mtf_fixture-repo.html#mtf_repo_isolation
