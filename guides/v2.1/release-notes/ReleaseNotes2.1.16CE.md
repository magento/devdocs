...
*Patch code and release notes were published on Novtember 18, 2018.*
...
Magento 2.1.15 conrtains 25 security fixes and enhancements.  See [Magento Security Center](https://magento.com/security/patches/magento-2.2.7-and-2.1.16-security-update) for more information.
