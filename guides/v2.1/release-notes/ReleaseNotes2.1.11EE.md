...
**Workaround**: Use the Devdocs [static Swagger site]({{ site.baseurl }}/swagger/index.html) to navigate to the REST call you want to use, then copy the payload structure to your Swagger instance.
