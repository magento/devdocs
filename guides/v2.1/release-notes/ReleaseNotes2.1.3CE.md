...
We are pleased to present Magento Community Edition 2.1.3. This release includes functional enhancements and fixes.
...
<!---60832-->* You can now successfully upgrade your Magento installation from CE 2.1.1 to EE 2.1.3. Previously, Magento threw an exception, "Default website not defined" after this upgrade. This is because Magento read the list of websites from the database, not from the config file (as it now does). 
...
<!---INTERNAL ONLY: 59791, 59678, 59645, 56585, 57593, 60536, 60060, 60062, 60064, 59873, 60348, 60471, 60561, 59675, 60289, 60525, 60554, 60427, 60479, 60366, 60053, 58359, 60898, 60460, 57375
-->
...
* **Issue**: <a href="https://github.com/magento/magento2/issues/6424" target="_blank">(GITHUB-6424)</a>. **Workaround**: 
<!--- 58017-->
