...
<!--- 47440 -->*  Magento now displays the correct product prices on the Configurable product page when [catalog](https://glossary.magento.com/catalog) prices include tax. [ (GITHUB-2471)](https://github.com/magento/magento2/issues/2471){:target="_blank"}
...
#### Braintree
{:.no_toc}
<!--- 48649-->* You can now change the quantity for an [invoice](https://glossary.magento.com/invoice).
