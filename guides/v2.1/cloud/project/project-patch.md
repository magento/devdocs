...
Our patches are Composer driven. When you perform a {{site.data.var.ece}} upgrade, you automatically upgrade with patches and hot fixes through the `composer update` command. See [Composer in Cloud]({{ page.baseurl }}/cloud/reference/cloud-composer.html).
