...
Before you continue, you must know the file system path to any patch we provided specifically to you. Typically, hotfixeses are in the `<Magento root dir>/m2-hotfixes` directory.
...
2.	Apply hotfixeses and other patches provided to you:

		git apply <path to patch>

	For example, to apply hotfixeses:
