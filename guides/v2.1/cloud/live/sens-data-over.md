...
1.	Delete `config.local.php` in your Development (Integration) environment.
...
2.	Make configuration changes in the Admin on the Development (Integration) environment.
