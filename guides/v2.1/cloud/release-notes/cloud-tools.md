...
-  Added the following new [**Environment variables**]({{ page.baseurl }}/cloud/env/variables-intro.html):
    ...
    -  <!-- MAGECLOUD-2129 -->The new [MIN_LOGGING_LEVEL]({{ page.baseurl }}/cloud/env/variables-intro.html) variable overrides the minimum logging level for all output streams without making changes to the code.
