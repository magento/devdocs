...
{% collapsible To create authorization keys: %}
Getting the Magento Enterprise Cloud Edition requires authorization keys. Only the account owner can create these keys.
