...
-  Submit a support ticket requesting the following Fastly service configuration updates required to handle the redirects: 

   -  Add the WordPress host to the Fastly backend configuration. Include the domain name for the project.
