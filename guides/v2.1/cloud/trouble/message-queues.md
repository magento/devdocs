...
Use the [`CRON_CONSUMERS_RUNNER` environment variable]({{site.baseurl}}/guides/v2.2/cloud/env/variables-deploy.html#cron_consumers_runner) to ensure that consumers are retrieving messages from the message queue.
