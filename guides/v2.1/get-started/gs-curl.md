...
<p>To create the endpoint in the call, append the REST URI that you constructed in [Step 3. Construct a request]({{ page.baseurl }}/get-started/gs-web-api-request.html) to this URL:</p>
...
<p>For a complete list of cURL command options, see [curl.1 the man page](http://curl.haxx.se/docs/manpage.html).</p>
...
<table style="width:75%">
   ...
   <tr>
      ...
      <td>
         ...
         <p>For a list of common headers used in Magento web API requests, see [HTTP headers]({{ page.baseurl }}/get-started/gs-web-api-request.html#http-headers).</p>
      </td>
   </tr>
   <tr>
      <td>
...
## Next step
<ul>
   <li>[Status codes and responses]({{ page.baseurl }}/get-started/gs-web-api-response.html)</li>
</ul>
