...
This topic discusses how to use the <a href="{{ site.mage2100url }}lib/internal/Magento/Framework/Pricing" target="_blank">Magento\Framework\Pricing</a> library in your module and how to add price rendering to page templates and layouts.
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Implements <a href="{{ site.mage2100url }}lib/internal/Magento/Framework/Pricing/Object/SaleableInterface.php" target="_blank">Magento\Framework\Pricing\Object\SaleableInterface</a>
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>Extends <a href="{{ site.mage2100url }}lib/internal/Magento/Framework/Pricing/Price/AbstractPrice.php" target="_blank">Magento\Framework\Pricing\Price\AbstractPrice</a>
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>Implements <a href="{{ site.mage2100url }}lib/internal/Magento/Framework/Pricing/Amount/AmountInterface.php" target="_blank">Magento\Framework\Pricing\Amount\AmountInterface</a>
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>Implements <a href="{{ site.mage2100url }}lib/internal/Magento/Framework/Pricing/Adjustment/AdjustmentInterface.php" target="_blank">Magento\Framework\Pricing\Adjustment\AdjustmentInterface</a>
        </p>
      </td>
    </tr>
  </tbody>
...
An example of Catalog module price configuration in its <a href="{{ site.mage2100url }}app/code/Magento/Catalog/etc/di.xml" target="_blank">di.xml</a>.
...
To specify what adjustments will be available for a product, add the corresponding adjustments to <code>AdjustmentPool</code> in the module's <code>di.xml</code>. An example of Catalog module price adjustments is shown in <a href="{{ site.mage2100url }}app/code/Magento/Catalog/etc/di.xml" target="_blank">di.xml</a>.

[//]: # "Steve removed this topic that the link leads to for dev beta because it's incomplete: To learn more about dependency injection files structure, see <a href="{{ site.gdeurl21 }}extension-dev-guide/depend-inj.html">Dependency injection</a>."
...
To learn about locations of layouts in Magento application, see <a href="{{ site.gdeurl21 }}frontend-dev-guide/layouts/xml-instructions.html">XML instructions</a>.

For example, the Catalog module's <a href="{{ site.mage2100url }}app/code/Magento/Catalog/view/base/layout/catalog_product_prices.xml" target="_blank">catalog_product_prices.xml</a> defines the basis for a product entity, so its pricing layout handle defines default values: render classes, templates, price types and adjustments. These values can be overridden by settings for particular product types in the `catalog_product_prices.xml` layout handle of the corresponding module.
