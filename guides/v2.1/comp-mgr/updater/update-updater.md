...
menu_node: parent
menu_order: 1
github_link21: comp-mgr/updater/update-updater.md
---
...
4.	If prompted, enter your Magento [authentication keys]({{ site.gdeurl21 }}install-gde/prereq/connect-auth.html).
