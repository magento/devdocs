...
*	[Customer module]({{ site.mage2100url }}app/code/Magento/Customer/composer.json){:target="_blank"}
*	[Luma theme]({{ site.mage2100url }}app/design/frontend/Magento/luma/composer.json){:target="_blank"}
*	[en_us language package]({{ site.mage2100url }}app/i18n/magento/en_us/composer.json){:target="_blank"}
