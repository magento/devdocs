...
[Example]({{ site.mage2100url }}app/code/Magento/Catalog/view/frontend/templates/product/compare/sidebar.phtml#L46-L48){:target="_blank"}
...
[Example]({{ site.mage2100url }}app/code/Magento/Catalog/view/frontend/web/js/view/compare-products.js){:target="_blank"}

All properties are available in the template.

[Example of defining a UI component in a layout]({{ site.mage2100url }}app/code/Magento/Catalog/view/frontend/layout/default.xml#L11-L22){:target="_blank"}
...
The following example adds comments to [app/code/Magento/Catalog/etc/frontend/sections.xml]({{ site.mage2100url }}app/code/Magento/Catalog/etc/frontend/sections.xml){:target="_blank"} to show you what the code is doing.
...
- [Checkout]({{ site.mage2100url }}app/code/Magento/Checkout/etc/frontend/sections.xml){:target="_blank"}

- [Customer]({{ site.mage2100url }}app/code/Magento/Customer/etc/frontend/sections.xml){:target="_blank"}
