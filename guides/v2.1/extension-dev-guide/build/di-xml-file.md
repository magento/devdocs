...
* In `index.php`, the [`\Magento\Framework\App\Http`]({{ site.mage2100url }}lib/internal/Magento/Framework/App/Http.php#L130-L132){:target="_blank"} class loads the area based on the front-name provided in the {% glossarytooltip a05c59d3-77b9-47d0-92a1-2cbffe3f8622 %}URL{% endglossarytooltip %}.

* In `static.php`, the [`\Magento\Framework\App\StaticResource`]({{ site.mage2100url }}lib/internal/Magento/Framework/App/StaticResource.php#L101-L104){:target="_blank"} class also loads the area based on the URL in the request.

* In `cron.php`, the [`\Magento\Framework\App\Cron`]({{ site.mage2100url }}lib/internal/Magento/Framework/App/Cron.php#L68-L70){:target="_blank"} class always loads the `crontab` area.
