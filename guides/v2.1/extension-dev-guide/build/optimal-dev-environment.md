...
* **Magento Devbox (Beta)**\\
  The Magento DevBox is the simplest way yet to install a Magento development system. DevBox puts the Magento application in a {% glossarytooltip 57f1b0dc-1341-466d-a685-e0dbf5a3b713 %}Docker{% endglossarytooltip %} container but all you have to do to set it up is run a script. No more installing an operating system, web server, PHP, and so on.[DevBox (Beta) quick installation overview]({{page.baseurl}}install-gde/docker/docker-over.html)
