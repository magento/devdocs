...
*	Setting {% glossarytooltip 8c0645c5-aa6b-4a52-8266-5659a8b9d079 %}XML{% endglossarytooltip %} attributes of blocks and containers.
	...
	<div class="bs-callout bs-callout-info" id="info">
		<p>Certain attributes, like <code>htmlClass</code>, <code>htmlId</code>, <code>label</code> attributes can be changed in [extending layouts]({{ page.baseurl }}/frontend-dev-guide/layouts/layout-extend.html" target="_blank).</p>
	</div>
