...
To add an extending <a href="{{site.gdeurl21}}frontend-dev-guide/layouts/layout-types.html#layout-types-conf" target="_blank">page configuration</a> or <a href="{{site.gdeurl21}}frontend-dev-guide/layouts/layout-types.html#layout-types-gen" target="_blank">generic layout</a> file:
...
To add an extending <a href="{{site.gdeurl21}}frontend-dev-guide/layouts/layout-types.html#layout-types-page" target="_blank">page layout</a> file:
...
*	<a href="{{ site.gdeurl21 }}frontend-dev-guide/layouts/xml-instructions.html" target="_blank">XML instructions</a>
*	<a href="{{ site.gdeurl21 }}frontend-dev-guide/themes/theme-create.html" target="_blank">Create a theme</a>
*	<a href="{{ site.gdeurl21 }}frontend-dev-guide/css-topics/theme-ui-lib.html" target="_blank">Magento UI library</a>
