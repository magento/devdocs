...
<img src="{{ site.baseurl }}common/images/inherit_mini121.png" alt="An image of a mini shopping cart where products are listed under the **Go to Checkout** button">
...
<img src="{{site.baseurl}}common/images/templ_overview_code121.png" alt="code">
...
<img src="{{site.baseurl}}common/images/templ_overview_code221.png" alt="code">

When the Orange theme was applied, the mini shopping cart with products looked like following:

<img src="{{site.baseurl}}common/images/inherit_mini221.png" alt="In the minishopping cart products are listed before the Go to Checkout button ">
