...
<ul>
<li>[styles-l.less]({{ site.mage2000url }}app/design/frontend/Magento/blank/web/css/styles-l.less) is used to generate desktop-specific styles (768px and higher).</li>
<li>[styles-m.less]({{ site.mage2000url }}app/design/frontend/Magento/blank/web/css/styles-m.less) is used to generate basic and mobile-specific styles.</li>
</ul>
