...
<p>In the Magento application, {% glossarytooltip 6c5cb4e9-9197-46f2-ba79-6147d9bfe66d %}CSS{% endglossarytooltip %} files are included in [layout files]({{ page.baseurl }}/frontend-dev-guide/layouts/layout-overview.html" target="_blank). </p>
...
<p>In a [theme directory]({{ page.baseurl }}/frontend-dev-guide/themes/theme-structure.html" target="_blank), stylesheets are stored in the following locations:</p>
...
<p>[<code>&lt;Magento_Blank_theme_dir&gt;/Magento_Theme/layout/default_head_blocks.xml</code>]({{ site.mage2000url }}app/design/frontend/Magento/blank/Magento_Theme/layout/default_head_blocks.xml" target="_blank)</p>
...
<span class="glyphicon-class">
 <p> If the system does not find the included CSS files, it searches for the same file names with a <code>.less</code> {% glossarytooltip 55774db9-bf9d-40f3-83db-b10cc5ae3b68 %}extension{% endglossarytooltip %}. This is part of the built-in preprocessing mechanism. You can find more information about it in the [CSS Preprocessing]({{ page.baseurl }}/frontend-dev-guide/css-topics/css-preprocess.html" target="_blank) topic.
</p></span> 
</div>
