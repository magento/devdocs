...
If your style changes do not apply after refreshing the page, cleaning the static files cache might help. See [Clean static files cache]({{ page.baseurl }}/frontend-dev-guide/cache_for_frontdevs.html#clean_static_cache) for instructions how to do this.
