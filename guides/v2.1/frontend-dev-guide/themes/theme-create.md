...
For illustration, see the <a href="{{site.mage2100url}}app/design/frontend/Magento/luma/registration.php">registration.php</a> file of the Magento Luma theme.
...
1.	Log in to your Magento server as a user with permissions to create directories and files in the Magento installation directory. (Typically, this is the <a href="{{ site.gdeurl21 }}install-gde/prereq/apache-user.html">the Magento file system owner</a>.)
...
For details about images configuration in `view.xml`, see the <a href="{{site.gdeurl21}}frontend-dev-guide/themes/theme-images.html" target="_blank">Configure images properties for a theme</a> topic.
...
To learn more about theme layouts, refer to the <a href="{{site.gdeurl21}}frontend-dev-guide/layouts/layout-overview.html" target="_blank">Layout section</a> of this guide.
