...
Before you run this command, you must do all of the following *or* you must <a href="{{ site.gdeurl21 }}install-gde/install/cli/install-cli-install.html">install the Magento software</a>:

*	<a href="{{ site.gdeurl21 }}install-gde/install/cli/install-cli-subcommands-deployment.html">Create or update the deployment configuration</a>
