...
menu_order: 200
version: 2.1
github_link21: install-gde/install/cli/install-cli-theme-uninstall.md
---
...
For more information about themes, see <a href="{{ site.gdeurl21 }}frontend-dev-guide/themes/theme-structure.html">Magento theme structure</a>.
...
*	Removing theme code from the file system.
	...
	<a href="{{ site.gdeurl21 }}frontend-dev-guide/themes/theme-inherit.html">More information about theme inheritance</a>.
...
*	`--clear-static-content` cleans generated <a href="{{ site.gdeurl21 }}config-guide/cli/config-cli-subcommands-static-view.html#config-cli-static-overview">static view files</a>, which is necessary to cause static view files to display properly.
...
12.	If `--clear-static-content` is specified, cleans <a href="{{ site.gdeurl21 }}config-guide/cli/config-cli-subcommands-static-view.html#config-cli-static-overview">generated static view files</a>.
