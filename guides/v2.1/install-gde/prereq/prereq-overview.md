...
*	Set up one or more hosts that meet the <a href="{{ site.gdeurl21 }}install-gde/system-requirements.html">Magento system requirements</a>.
...
<div class="bs-callout bs-callout-info" id="info">
<span class="glyphicon-class">
  <p>Don't know what any of this means? Check out our <a href="{{ site.gdeurl21 }}install-gde/bk-install-guide.html">installation overview page</a>.</p></span>
</div>
...
To install or upgrade Apache, see <a href="{{ site.gdeurl21 }}install-gde/prereq/apache.html">Apache</a>.
...
To install or upgrade MySQL, see <a href="{{ site.gdeurl21 }}install-gde/prereq/mysql.html">MySQL</a>.
...
*	<a href="{{ site.gdeurl21 }}install-gde/system-requirements.html">Magento system requirements</a>
