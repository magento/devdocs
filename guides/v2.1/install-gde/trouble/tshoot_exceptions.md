...
Clear the `<magento_root>/var/generation` and other directories under `var` as follows:

	rm -rf <magento_root>/var/generation/* <magento_root>/var/di/* <magento_root>/var/cache/* 
