...
menu_order: 400
version: 2.1
github_link21: install-gde/trouble/php/tshoot_phpini.md
---
...
3.	If you haven't already done so, set up a <a href="{{ site.gdeurl21 }}install-gde/prereq/optional.html#install-optional-phpinfo">phpinfo.php</a> on your web server.
