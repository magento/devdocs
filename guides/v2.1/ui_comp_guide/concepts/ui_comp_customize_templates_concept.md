...
group: UI Components
subgroup: Concepts
title: About templates customization rules & techniques (using Knockout.js)
menu_title: About templates customization rules & techniques (using Knockout.js)
menu_order: 1
version: 2.1
github_link: ui_comp_guide/concepts/ui_comp_customize_templates_concept.md
---


#  About templates customization rules & techniques (using Knockout.js)
* TOC
{:toc}
...
This topic discusses the templates customization rules & techniques (using Knockout.js)....

## Implementation Details

* UI Comps implement the MVVM pattern (the UI component instance is a ViewModel)
* "Some words about what each html tag and attributes means and how it works would make everyone understand the ui components power."
* Note about using native Knockout syntax (2.0), but in 2.1 we recommend that they use our new templates (extended from Knockout ones) with new html tags to allow greater flexibility
* Note that the templates for Form and Grid use xhtml; explain why, advantages (cross-link to the Form and Grid topics)
