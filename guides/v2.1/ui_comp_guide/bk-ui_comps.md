...
1. [definition.xml]({{ site.mage2100url }}app/code/Magento/Ui/view/base/ui_component/etc/definition.xml): default component's configuration. Can be extended in custom modules.
