...
Removed Fastly VCL snippet for extending the Admin timeout. Magento Commerce Cloud Admin users can configure the timeout from the [Magento Admin UI](https://devdocs.magento.com/guides/v2.2/cloud/cdn/configure-fastly.html).|2.1.x, 2.2.x, 2.3.x|Technical changes|Sep 4
...
Documented a more secure method of [adding authentication credentials]({{page.baseurl}}/cloud/setup/first-time-setup-import-prepare.html#auth-json) to a Cloud project.|2.1.x, 2.2.x, 2.3.x|Technical changes|Aug 22
...
[Magento Functional Testing Framework Guide]({{ site.baseurl }}/guides/v2.2/magento-functional-testing-framework/introduction.html)|2.2.x|New|Dec 08
...
Updated Magento Commerce (Cloud) for [Import existing code into a project]({{ site.baseurl }}/guides/v2.2/cloud/setup/first-time-setup-import-first-steps.html), [Prepare your existing Magento Commerce code]({{ site.baseurl }}/guides/v2.2/cloud/setup/first-time-setup-import-prepare.html), [Import code and data to Magento Commerce (Cloud)]({{ site.baseurl }}/guides/v2.2/cloud/setup/first-time-setup-import-import.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 22
...
Updated [Set up Fastly]({{ site.baseurl }}/guides/v2.2/cloud/cdn/configure-fastly.html) and [Fastly troubleshooting]({{ site.baseurl }}/guides/v2.2/cloud/trouble/trouble_fastly.html) for Magento Commerce (Cloud) for handling existing Fastly accounts|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 14
...
Added information for Fastly [set up]({{ site.baseurl }}/guides/v2.2/cloud/basic-information/cloud-fastly.html), [custom VCL snippets]({{ site.baseurl }}/guides/v2.2/cloud/cdn/cloud-vcl-custom-snippets.html), and [troubleshooting]({{ site.baseurl }}/guides/v2.2/cloud/trouble/trouble_fastly.html)|2.0.x, 2.1.x, 2.2.x, 2.x|New|Aug 28
