...
Removed Fastly VCL snippet for extending the Admin timeout. Magento Commerce Cloud Admin users can configure the timeout from the [Magento Admin UI](https://devdocs.magento.com/guides/v2.2/cloud/cdn/fastly.html).|2.1.x, 2.2.x, 2.3.x|Technical changes|Sep 4
