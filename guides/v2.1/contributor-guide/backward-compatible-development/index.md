...
* [Topic names for message queue]({{ site.baseurl }}/extension-dev-guide/message-queues/config-mq.html), except autogenerated names (e.g. topic names generated by [Asynchronous Web API]({{ site.baseurl }}/rest/asynchronous-web-endpoints.html)). Autogenerated topic names should be treated as private implementation and may be changed at any time if needed.
