...
There is no <code>mage/menu.js</code> in the current theme or parent theme JS files, so the source file for menu component used for the main navigation menu is <a href="{{ site.mage2000url }}lib/web/mage/menu.js" target="_blank"><code>lib/web/mage/menu.js</code></a>
</ol>
