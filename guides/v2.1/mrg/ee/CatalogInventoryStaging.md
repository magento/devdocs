...
You can interact with the Magento_CatalogInventoryStaging module using the Magento [extension](https://glossary.magento.com/extension) mechanism, see [Magento plug-ins]({{ site.baseurl }}/guides/v2.1/extension-dev-guide/plugins.html).
