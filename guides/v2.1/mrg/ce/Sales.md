...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Array of items with a format according to [<code>\Magento\Sales\Api\Data\InvoiceItemCreationInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/InvoiceItemCreationInterface.php).</td>
      <td>
      {% highlight json %}
      [
          {
    ...
    <tr>
      ...
      <td>A format according to [<code>\Magento\Sales\Api\Data\InvoiceCommentCreationInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/InvoiceCommentCreationInterface.php).</td>
      <td>
      {% highlight json %}
      {
    ...
    <tr>
      ...
      <td>A format according to [<code>\Magento\Sales\Api\Data\InvoiceCreationArgumentsInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/InvoiceCreationArgumentsInterface.php).</td>
      <td>&nbsp;</td>
      <td>Optional</td>
      <td><code>null</code></td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Array of items with a format according to [<code>\Magento\Sales\Api\Data\ShipmentItemCreationInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/ShipmentItemCreationInterface.php).</td>
      <td>
        {% highlight json %}
        [
            {
    ...
    <tr>
      ...
      <td>A format according to the
        [<code>\Magento\Sales\Api\Data\CreditmemoCommentCreationInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/CreditmemoCommentCreationInterface.php)
        interface.</td>
      <td>
      {% highlight json %}
      {   
    ...
    <tr>
      ...
      <td> Array of objects with a format according to
        [<code>\Magento\Sales\Api\Data\ShipmentTrackCreationInterface></code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/ShipmentTrackCreationInterface.php). </td>
      <td>
      {% highlight json %}
      [
          {
    ...
    <tr>
      ...
      <td> Array of objects with a format according to
        [<code>\Magento\Sales\Api\Data\ShipmentPackageCreationInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/ShipmentPackageCreationInterface.php). </td>
      <td>
      {% highlight json %}
      [
          {
    ...
    <tr>
      ...
      <td>A format according to the
        [<code>\Magento\Sales\Api\Data\CreditmemoCreationArgumentsInterface</code>]({{ site.mage2100url }}app/code/Magento/Sales/Api/Data/CreditmemoCreationArgumentsInterface.php)
        interface.</td>
      <td>&nbsp;</td>
      <td>Optional</td>
      <td><code>null</code></td>
