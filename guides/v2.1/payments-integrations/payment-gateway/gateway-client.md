...
The basic interface for a gateway client is [`Magento\Payment\Gateway\Http\ClientInterface`]({{ site.mage2100url }}app/code/Magento/Payment/Gateway/Http/ClientInterface.php).
...
* [\Magento\Payment\Gateway\Http\Client\Zend]({{ site.mage2100url }}app/code/Magento/Payment/Gateway/Http/Client/Zend.php)
* [\Magento\Payment\Gateway\Http\Client\Soap]({{ site.mage2100url }}app/code/Magento/Payment/Gateway/Http/Client/Soap.php)
...
Transfer Factory uses [Transfer Builder]({{ site.mage2100url }}app/code/Magento/Payment/Gateway/Http/TransferBuilder.php) to set required request parameters. 

The basic Transfer Factory interface is [Magento\Payment\Gateway\Http\TransferFactoryInterface]({{ site.mage2100url }}app/code/Magento/Payment/Gateway/Http/TransferFactoryInterface.php).
