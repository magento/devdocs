...
4. Implement and configure [gateway commands]({{page.baseurl}}gateway-command.html). Described in [Add a gateway command]({{page.baseurl}}payments-integrations/base-integration/payment-action.html) 
