...
<div class="bs-callout bs-callout-info" id="info">
  <p>This rule applies only to production code. When writing [integration tests]({{ page.baseurl }}/test/integration/integration_test_execution.html), this is not true. In fact, the object manager is recommended for integration tests.</p>
</div>
