...
* <a href="{{ site.gdeurl21 }}install-gde/bk-install-guide.html">Install Magento 2</a> on a system that meets our <a href="{{ site.gdeurl21 }}install-gde/system-requirements.html">system requirements</a>

<h4>Start your migration</h4>
<ol>
  <li>Make sure that the <a href="{{ site.gdeurl21 }}migration/migration-tool.html">Data Migration Tool</a> has a network access to connect to Magento 1 and Magento 2 databases. Open ports in your firewall.</li>
...
<pre>NOTE: Activity cannot resume until your Magento 2 store goes live.</pre>
  ...
  <li>Use the migration tool to <a href="{{ site.gdeurl21 }}migration/migration-migrate-settings.html">migrate settings</a> and websites.</li>
...
* Start the <a href="{{ site.gdeurl21 }}migration/migration-migrate-delta.html">incremental migration</a>; updates run continually. 
...
4. In your Magento 2 system, reindex the stock indexer using the command <a href="{{ site.gdeurl21 }}config-guide/cli/config-cli-subcommands-index.html#config-cli-subcommands-index-reindex">`magento indexer:reindex cataloginventory_stock`</a>.
...
For full information please see the complete <a href="{{ site.gdeurl21 }}migration/bk-migration-guide.html">Migration Guide</a>
