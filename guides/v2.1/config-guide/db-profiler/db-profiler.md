...
Modify `<your Magento install dir>/app/etc/env.php` to add the following reference to the [database profiler class]({{ site.mage2100url }}lib/internal/Magento/Framework/DB/Profiler.php):
