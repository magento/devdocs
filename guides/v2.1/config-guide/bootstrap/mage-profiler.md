...
Magento provides the base functionality in [Magento\\Framework\\Profiler]({{ site.mage2100url }}lib/internal/Magento/Framework/Profiler.php){:target="_blank"}.
...
-   `1` to enable a specific profiler's output.
    ...
    - `csvfile` which uses [Magento\\Framework\\Profiler\\Driver\\Standard\\Output\\Csvfile]({{ site.mage2100url }}lib/internal/Magento/Framework/Profiler/Driver/Standard/Output/Csvfile.php){:target="_blank"}
    - Any other value (except `2`), including an empty value, which uses [Magento\\Framework\\Profiler\\Driver\\Standard\\Output\\Html]({{ site.mage2100url }}lib/internal/Magento/Framework/Profiler/Driver/Standard/Output/Html.php){:target="_blank"}
