...
Enter the following command:
	...
	curl -i http://<host name, ip, or localhost>:<nginx proxy port>/_cluster/health
...
Now try the following command:
	...
	curl -i -u <user name>:<password> http://<host name, ip, or localhost>:<nginx proxy port>/_cluster/health
