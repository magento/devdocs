...
[Magento\Framework\App\DeploymentConfig]({{ site.mage2100url }}lib/internal/Magento/Framework/App/DeploymentConfig.php) merely provides access to these sections but does not allow you to extend them.
