...
menu_order: 4
version: 2.1
github_link21: ext-best-practices/extension-coding/observers-bp.md
...
### Overview
[Observers]({{site.gdeurl21}}extension-dev-guide/events-and-observers.html) are capable of modifying the behavior of a Magento application because they are dynamically injected into the execution flow. Poorly designed and coded observers can cause issues, instabilities, or otherwise break the application.
...
### Recommended Reading
* [Events and Observers]({{site.gdeurl21}}extension-dev-guide/events-and-observers.html)
