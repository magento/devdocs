...
menu_order: 1
menu_node: parent
github_link21: ext-best-practices/admin/admin-best-practices.md
---
...
For additional information on design topics for the Admin, read the [Admin Pattern Library]({{site.gdeurl21}}pattern-library/bk-pattern.html) and the [Admin Style Guide]({{site.gdeurl21}}design-styleguide/bk-styleguide.html).
