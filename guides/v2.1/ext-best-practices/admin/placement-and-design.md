...
For more information about icon design and Magento's icon library, see the article about  [Iconography]({{site.gdeurl21}}design-styleguide/iconography/iconography.html) in the Admin Style Guide book.
