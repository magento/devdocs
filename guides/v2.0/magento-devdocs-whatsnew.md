...
|--------------|--------------|----------------------|--------|
| [Magento application environment variables](http://devdocs.magento.com/guides/v2.0/cloud/env/environment-vars_magento.html)){:target="_blank"} | 2.0, 2.1 |  Update | June 27  |
...
| [Manage comapany users](http://devdocs.magento.com/guides/v2.2/b2b/company-users.html){:target="_blank"} | 2.2 |  New | June 23  |
