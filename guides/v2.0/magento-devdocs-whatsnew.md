...
| [MECE add more information about project directory structure]({{ page.baseurl }}/cloud/setup/first-time-setup-dir-structure.html){:target="_blank"}  | 2.x  | Updated  |  Oct 7 |
