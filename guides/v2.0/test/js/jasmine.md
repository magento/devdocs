...
Let's see how to write a test using an example of existing test:
...
{% collapsible See full code of the test%}
...
[Learn more about testing with Jasmine.]: [Learn more about testing with Jasmine.]
