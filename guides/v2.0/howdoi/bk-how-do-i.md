...
To sign up to contribute, all you need to do is to submit a <a href="{{ page.baseurl }}howdoi/howdoi_contribute.md">pull request on the sign-up page</a> or <a href="mailto:DL-Magento-Doc-Feedback@magento.com">e-mail us</a>. 
