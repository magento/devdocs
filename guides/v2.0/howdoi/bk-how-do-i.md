...
All content submitted to us is subject to internal review. Content should be consistent with Magento practices, including [coding standards]({{ page.baseurl }}/coding-standards/bk-coding-standards.html).
</div>
