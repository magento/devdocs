...
Let's consider a case where you need to add a check box whose state (selected or cleared) changes the state of other fields. When the check box is selected, the Shipping Address fields prepopulate with a certain address.
