...
### Failure
If the update fails, click **Rollback** to restore an earlier backup. Errors display in the Console Log as shown in the following figure. For more information, see <a href="{{ site.gdeurl }}comp-mgr/trouble/cman/update-fail.html">Roll back after update failure</a>.<br>
