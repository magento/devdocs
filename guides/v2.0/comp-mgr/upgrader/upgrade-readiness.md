...
The following figure shows an example of a successful readiness check. If all tests passed, click **Next** and continue with <a href="{{page.baseurl}}comp-mgr/upgrader/upgrade-backup.html">Step 3. Backup</a>.
...
*	<a href="{{page.baseurl}}install-gde/trouble/php/tshoot_php-set.html">PHP settings check failure</a>
