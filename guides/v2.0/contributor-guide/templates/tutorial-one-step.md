---
layout: tutorial-one-step
group: contributor
subgroup: templates
title: One-step tutorial template
menu_title: One-step tutorial template
menu_order: 9
level3_menu_node:
level3_subgroup: sample-one-step-tutorial
version: 2.0
github_link: contributor-guide/tutorial-one-step.md
---
