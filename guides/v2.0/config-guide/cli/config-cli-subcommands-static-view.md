...
You can clean generated static view files in several ways. Refer to [Clean static files cache information]({{ page.baseurl }}/frontend-dev-guide/cache_for_frontdevs.html#clean_static) for more information.
</div>
