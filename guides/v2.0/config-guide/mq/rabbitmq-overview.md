...
See <a href="{{page.baseurl}}extension-dev-guide-guide/message-queues/config-mq.html">Configure message queues</a> for information about setting up the message queue system.
