...
Instructions on how to extend `Magento\Framework\Cache\Core` to provide support for low-level frontend caches are beyond the scope of this guide.
...
*   Database
*   <a href="{{ site.gdeurl }}config-guide/memcache/memcache.html">memcache</a>
*   File system (default)
