...
This topic discusses how to use Varnish with Magento. To do that, we provide verification suggestions along the way. Also, you'll initially configure Varnish with a minimal set of parameters. Later, after you know Varnish works, you'll export a Varnish configuration from the Magento Admin that adds many more fine-tuned configuration options.
...
2.	Install the Magento software and use the Magento Admin to create a Varnish configuration file. Replace your existing Varnish configuration file with the one generated by the Admin.
3.	Test everything again by, among other things, making sure there is nothing in your `<your Magento install dir>/var/page_cache` directory. If not, you've successfully configured Varnish with Magento!
