...
New users can now complete a full installation of Magento Open Source 2.0.7 from an archive file on the [Download](https://www.magentocommerce.com/download){: target="_blank"} page.
