...
<!-- 50500 -->* Magento now allows Ajax requests to use additional parameters found in the URL path. Previously, you could pass additional parameters only for arguments declared at the top level.
