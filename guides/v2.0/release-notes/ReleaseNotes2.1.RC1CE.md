...
We are pleased to present Magento Community Edition 2.1 RC1. This release candidate build is not intended for production purposes. Instead, it provides a preview of the new features and fixes that Magento Community Edition 2.1 GA will contain.
