...
You can change these breakpoints and add new ones in your custom theme. For instructions see the [Add a new breakpoint]({{site.gdeurl}}frontend-dev-guide/css-topics/css-breakpoints.html) topic.
