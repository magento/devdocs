...
This topic describes how to uninstall a storefront theme in Magento 2.
...
2. Make sure that the theme is not applied on the storefront. To do this, in the Admin panel navigate to **STORES** > **Configuration**>**Design** and make sure that your custom theme is not applied for any store view.
