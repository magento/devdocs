...
3. In table **Design Configurationw**, select the store view where you want to apply the theme.
4. In the **Applied Theme** drop-down field, select your newly created theme.
