...
<li>After you <a href="({{page.baseurl}}frontend-dev-guide/css-topics/css-preprocess.html#css_exception)">customize the root source files or move the files included to the root files</a>, run the <code>exec</code> command and reload the page.</li>
...
<li>After you <a href="({{page.baseurl}}frontend-dev-guide/css-topics/css-preprocess.html#css_exception)">customize the root source files or move the files included to the root files</a>, run the <code>clean</code> and <code>exec</code> commands, and the browser page reloads automatically.</li>
