...
For details, refer to [Layout file types]({{ page.baseurl }}/frontend-dev-guide/layouts/layout-types.html){: target="_blank"}.
...
2.	Determines the sequence of [inherited]({{ page.baseurl }}/frontend-dev-guide/themes/theme-inherit.html){: target="_blank"} themes `[<parent_theme>, ..., <parent1_theme>] <current_theme>`
...
*	[Common layout customization tasks]({{ page.baseurl }}/frontend-dev-guide/layouts/xml-manage.html){: target="_blank"}
...
*	[Customizing layout - step-by-step illustration]({{ page.baseurl }}/frontend-dev-guide/layouts/layout-practice.html){: target="_blank"}
