...
The template responsible for displaying the mini-shopping cart items and controls is `<Magento_Checkout_module_dir>/view/frontend/web/template/minicart/content.html`.
