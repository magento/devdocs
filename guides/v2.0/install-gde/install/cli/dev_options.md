...
*	To <a href="{{ site.gdeurl }}install-gde/install/cli/dev_downgrade.html">change versions</a> from `develop` to a release version like `2.0.2`, you must uninstall the Magento software and install the released version.
