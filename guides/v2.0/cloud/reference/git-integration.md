...
We support using integrations with GitHub and BitBucket. We use GitHub primarily for repositories and highly recommend the service. For details on configuring, see our integration guide for [Github]({{page.baseurl}}cloud/project/project-integrate-github.html). For setting up BitBucket, see [Manage branches with the Project Web Interface]({{page.baseurl}}cloud/project/project-integrate-github.html#cloud-deploykey-bb).
