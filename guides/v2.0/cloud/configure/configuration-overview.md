...
For Pro 2.2.X subscriptions, you can also add [Magento B2B module]({{ page.baseurl }}cloud/configure/setup-b2b.html).

## Configure your deploy: build hooks, services, and routes {#configurations}
