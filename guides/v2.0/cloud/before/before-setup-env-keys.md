...
<div class="bs-callout bs-callout-info" id="info" markdown="1">
This variable works for all Starter environments including Production `master`. For Pro plans, this variable is only available in the Development (Integration) environments.
</div>
