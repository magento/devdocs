...
Use this procedure whether you're starting a new project from scratch or if you're importing an existing Magento installation to Enterprise Cloud Edition. When you initially set up a project from a template, we retrieve the code from the <a href="https://github.com/magento/magento-cloud-configuration" target="\_blank" data-proofer-ignore><code>magento-cloud-configuration</code> repository</a>
