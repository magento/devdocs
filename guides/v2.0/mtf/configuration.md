...
<tr>
    ...
    <td><code>"&lt;PHPUnit reports directory&gt;"</code></td>
    <td></td>
</tr>
<tr>
...
**Добавить пример использования после таблицы - https://wiki.corp.magento.com/display/OE/MTF+Tutorial+-+Isolation+Management**
