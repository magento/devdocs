...
The Selenium Server is located in `<magento_root>/dev/tests/functional/vendor/netwing/selenium-server-standalone` directory. If you cannot find this directory, please <a href="{{site.gdeurl}}mtf/mtf_installation.html#mtf_install_check">check MTF installation</a>.
