...
The dependencies declared by A are usually class & interfaces, and B provides the concrete implementations for those interfaces declared by A as dependency on B.
