...
Incremental migration enables you to migrate only the changes made in Magento 1 since you migrated data. This data was all added on storefront by customers (created orders, reviews, changes in customer profiles etc.) and all operations with orders in Admin.
