 ...
 *  Return a response, which can be:
	...
	*	[Service data object]({{ site.baseurl }}guides/v1.0/m2devgde/svcs-framework/build-svc.html#about-service-data-objects). A service data object holds only primitives or other service data objects and so on. 
...
To set up a service so it can be accessed using REST, see [What is the Web API Framework?]({{ site.baseurl }}guides/v1.0/m2devgde/webapi/what-is-webapi.html)
