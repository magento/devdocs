...
title: JavaScript Unit Test User Guide
---
 
<h1 id="m2devgde-test-jsunit-user">{{ page.title }}</h1>

<p><a href="{{ site.githuburl }}m2devgde/code-test/test_js-unit-user.md" target="_blank"><em>Help us improve this page</em></a>&nbsp;<img src="{{ site.baseurl }}common/images/newWindow.gif"/></p>

<h2 id="m2devgde-jsunituser-intro">Using Magento JavaScript Unit Tests</h2> 

Wiki reference: https://wiki.magento.com/display/MAGE2DOC/Javascript+Unit+Tests+User+Guide
