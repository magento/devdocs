...
4.	Update the Magento code:
	...
	<div class="bs-callout bs-callout-info" id="info">
		<span class="glyphicon-class">
  			<p>If <code>git pull develop</code> fails, see <a href="{{ site.gdeurl }}install-gde/trouble/tshoot_git-pull-origin.html">git pull origin fails when updating the Magento software</a>.</p></span>
	</div>
