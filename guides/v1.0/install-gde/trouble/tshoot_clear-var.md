...
Running Magento processes at the same time might result in problems creating the installation log. (For example, two installations in different tab pages or the Setup Wizard in one tab page and the storefront in another.)
