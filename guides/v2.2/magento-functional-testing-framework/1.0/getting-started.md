...
version: 2.2
github_link: magento-functional-testing-framework/1.0/getting-started.md
functional_areas:
 - Testing
redirect_from: guides/v2.2/magento-functional-testing-framework/getting-started.html
---
