...
* [`seralize`](http://php.net/manual/en/function.serialize.php){:target="_blank"}/[`unserialize`](http://php.net/manual/en/function.unserialize.php){:target="_blank"} - Like `eval`, attackers can exploit the vulnerability of the `unserialize` function to [run arbitrary code](https://heine.familiedeelstra.com/security/unserialize){:target="_blank"}.
