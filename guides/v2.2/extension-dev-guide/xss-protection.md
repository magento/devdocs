...
`escapeJsQuote` | Used for escaping quotes in Java Script
`escapeQuote` | Used for escaping quotes inside html attributes
...
`escapeXssInUrl()` | Used for escaping xss in urls
