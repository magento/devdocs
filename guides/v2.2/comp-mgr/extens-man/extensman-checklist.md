...
The Extension Manager enables you to install, uninstall, and update components, including those you purchase from Magento Marketplace. The term *component* (sometimes referred to as *extension*) means:
