...
The ActionDelete component provides user interface for deleting records of the [DynamicRows component]({{page.baseurl}}ui_comp_guide/components/ui-dynamicrows.html).
