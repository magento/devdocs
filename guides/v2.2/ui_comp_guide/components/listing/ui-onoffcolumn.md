...
The OnOffColumn component is a decorator for [MultiselectColumn]({{page.baseurl}}ui_comp_guide/components/listing/ui-multiselectcolumn.html) that displays toggle switch elements instead of check boxes.
