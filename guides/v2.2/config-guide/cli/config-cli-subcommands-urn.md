...
{: .bs-callout-info}
Run `dev:urn-catalog:generate` command each time when you add/modify/remove Magento 2 modules which contain `*.xsd` files to keep your "Schemas and DTDs" up do date.
