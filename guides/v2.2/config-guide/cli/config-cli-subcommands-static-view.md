...
<table>
    ...
    <tr>
        ...
        <td>Define the deployment strategy.</a> <p>Use "quick" strategy, if you have more than one locale. If additionally the amount of server space taken by the published view files is one of your concerns, use the "compact" strategy.<p>By default, the "quick" strategy is used.</p> <p>For details about the implementation of each strategy, see the <a href="{{page.baseurl}}config-guide/cli/config-cli-subcommands-static-deploy-strategies.md">Deployment strategies</a> topic.</p></td>
        <td><p>No</p></td>
    </tr>
    <tr>
        <td>--force (-f)</td>
