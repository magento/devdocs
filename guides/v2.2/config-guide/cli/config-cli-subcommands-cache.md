...
<div class="bs-callout bs-callout-info" id="info">
<span class="glyphicon-class">
  <p>You can not disable cache in backend configuration (<strong>System</strong> > Tools > <strong>Cache Management</strong>) in <b>production</b> mode. Use CLI commands instead.</p></span>
</div>
