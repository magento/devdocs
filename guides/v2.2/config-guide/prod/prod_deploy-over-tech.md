...
*   Set up the same Magento file system owner <!-- {% glossarytooltip 5e7de323-626b-4d1b-a7e5-c8d13a92c5d3  %}Magento file system owner{% endglossarytooltip %} --> user name on all systems _and_ make sure the web server runs as the same user on all systems
