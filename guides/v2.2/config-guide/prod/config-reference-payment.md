...
These options are available only if you chose the United Kingdom as the [merchant country]({{page.baseurl}}config/config-reference_sensitive.htmlvars-merch-country).
