...
<td>server</td>
<td>Fully qualified hostname, IP address, or a an absolute path to a UNIX socket. The default value of <code>127.0.0.1</code> indicates Redis is installed on the Magento server.</td>
