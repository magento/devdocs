...
- [{{site.data.var.ce}} changes]({{page.baseurl}}release-notes/changes/ce_changes.html)
- [{{site.data.var.ee}} changes]({{page.baseurl}}release-notes/changes/ee_changes.html)
