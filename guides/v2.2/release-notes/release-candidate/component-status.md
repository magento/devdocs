...
| Name                                           | Status |
| ---------------------------------------------- | ------ |
| Infrastructure/ Functional Tests               | <span class="status red">Red</span>    |
| Infrastructure/ JS framework                   | <span class="status red">Red</span>    |
...
| Name                      | Status |
| ------------------------- | ------ |
| Module/ SharedCatalog     | <span class="status yellow">Yellow</span> |
