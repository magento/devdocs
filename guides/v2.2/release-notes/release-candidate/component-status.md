...
| Infrastructure/ JS framework                   | <span class="status yellow">Yellow</span> |
| Module/ Analytics                              | <span class="status yellow">Yellow</span> |
| Module/ UrlRewrite                             | <span class="status yellow">Yellow</span> |
...
| Module/ SalesSequence                          | <span class="status yellow">Yellow</span> |
| Module/ Sample Data                            | <span class="status yellow">Yellow</span> |
| Module/ Shipping                               | <span class="status yellow">Yellow</span> |
...
| Name                    | Status |
| ----------------------- | ------ |
| Module/ Digital Content | <span class="status yellow">Yellow</span> |
