...
3.	Download the {{site.data.var.ce}} or {{site.data.var.ee}} metapackage.
    ...
    -   Enter the following command for {{site.data.var.ce}}:
            ...
            composer create-project --repository-url=https://repo.magento.com/ magento/project-community-edition <install-directory-name> 2.2.0-rc2

    -   Enter the following command for {{site.data.var.ee}}:

            composer create-project --repository-url=https://repo.magento.com/ magento/project-enterprise-edition <install-directory-name> 2.2.0-rc2
