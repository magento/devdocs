...
After you've successfully tested a patch locally and on your Development (Integration) environment, you can push the patch to Staging or Production environment:
