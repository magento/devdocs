  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p>You must set the variable value using JSON. Refer to <a href="http://devdocs.magento.com/guides/v2.2/cloud/env/use-cases.html#manage-message-queues">Manage message queues</a> for more information.</p>
      </td>
      <td>not set</td>
    </tr>
    <tr>
