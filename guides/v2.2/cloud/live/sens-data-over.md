...
<td>
<ol><li>Transfer <code>config.php</code> to your local system using <code>rsync</code> or <code>scp</code>. You can only add this file to the Git branch through your local.
