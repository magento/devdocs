...
*	Sensitive data, such as payment processor passwords and API keys, is pushed into environment variables file (`/app/etc/env.php`) or manually added using either environment variables or using the Magento Admin only.
...
<div class="bs-callout bs-callout-warning" markdown="1">
While you can manually edit `config.php` in Staging and Production, we don't recommend it. The file helps keep consistent configurations across your entire environment.
</div>
