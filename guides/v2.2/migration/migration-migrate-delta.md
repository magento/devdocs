...
{: .bs-callout-info }
All new or updated entities entered through the Admin panel, such as attributes, CMS pages, etc., are not included in the incremental migration and will not be migrated.
