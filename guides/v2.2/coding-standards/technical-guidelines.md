...
5.20. Plugin MUST only throw exceptions declared by the method to which the plugin is added. Observer MUST only throw exceptions declared by the method that triggers an event.
