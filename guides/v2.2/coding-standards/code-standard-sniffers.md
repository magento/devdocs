...
You can use our custom rule set with the code sniffer to be confident that your code meets magento coding standards.

The rule set is located in [`dev/tests/static/framework/Magento/ruleset.xml`][ruleset.xml].
