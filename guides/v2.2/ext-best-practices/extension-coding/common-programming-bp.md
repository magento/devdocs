...
Access to method parameters was the main excuse to use **around** instead of **after** plugin. 

Since 2.2 [after method plugins]({{page.baseurl}}extension-dev-guide/plugins.html#after-methods) gives you access to method parameters. Use after method plugins if you require arguments for replacing or altering function results. 
</div>
