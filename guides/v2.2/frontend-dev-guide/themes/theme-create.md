...
* [Checklist of modules]({{site.mage2200url}}app/code/Magento){:target="\_blank"}
...
1.	Log in to your Magento server as a user with permissions to create directories and files in the Magento installation directory. (Typically, this is the the [Magento file system owner]({{page.baseurl}}/install-gde/prereq/apache-user.html).)
