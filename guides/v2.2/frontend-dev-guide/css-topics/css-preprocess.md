...
NOTE: Manual static content deployment is not required in "default" and "developer" modes. If you still want to deploy in these modes, use the -f option: 'bin/magento setup:static-content:deploy -f'
