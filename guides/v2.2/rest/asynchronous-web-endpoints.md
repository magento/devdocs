...
Use the `bin/magento queue:consumers:start async.operations.all` command to run consumer which is responsible for handling of Asynchronous/Bulk API messages.
