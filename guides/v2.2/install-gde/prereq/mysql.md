...
1.	*CentOS 6* Install the MySQL database:
    ...
    ```shell
    sudo wget http://repo.mysql.com/mysql-community-release-el6-5.noarch.rpm && sudo rpm -ivh
    ```
...
2.	*CentOS 7* Install the MySQL database:
    ...
    ```shell
    sudo wget http://repo.mysql.com/mysql-community-release-el7-5.noarch.rpm && sudo rpm -ivh 
    ```
