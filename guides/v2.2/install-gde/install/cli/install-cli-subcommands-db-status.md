...
|--------------|--------------|--------------|
 ...
 2 | setup:upgrade is required | [`magento setup:upgrade`]({{ page.baseurl }}install-gde/install/cli/install-cli-subcommands-db-upgr.html) to update the database schema |
