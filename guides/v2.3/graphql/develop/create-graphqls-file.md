...
Output types that represent entities, which should be manipulated (updated, removed, etc.) and/or can be cached on the client, MUST have `id` field. Type of the field SHOULD be `ID`.
