...
The `customerCart` query differs from the `cart` query in that it must be run on behalf of a logged-in customer. If you run this query on behalf of a guest, an exception will be thrown.
