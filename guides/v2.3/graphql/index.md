...
For example, the [`Catalogschema.graphqls`]({{ site.mage2bloburl }}/{{ page.guide_version }}/app/code/Magento/CatalogGraphQl/etc/schema.graphqls) file declares multiple EAV attributes.
