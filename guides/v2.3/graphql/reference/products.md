...
`crosssell_products` | [[ProductInterface](#ProductInterface)] | Cross-sell product(s)
...
`related_products` | [[ProductInterface](#ProductInterface)] | Related product(s)
...
`upsell_products` | [[ProductInterface](#ProductInterface)] | Up-sell product(s)
