...
`image` | ProductImage | An object of [ProductImage](#ProductImage) that contains the URL and label for the main image on the product page
...
`small_image` | ProductImage | An object of [ProductImage](#ProductImage) that contains the URL and label for the small image used on catalog pages
...
`thumbnail` | ProductImage | An object of [ProductImage](#ProductImage) that contains the URL and label for the product's thumbnail image
