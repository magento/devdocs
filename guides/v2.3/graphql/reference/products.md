...
`url_rewrites` | [UrlRewrite] | A list of URL rewrites. See [urlResolver query]({{ page.baseurl }}/graphql/queries/url-resolver.html#UrlRewrite) for more information and an example query
