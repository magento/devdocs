...
`sort` | `ProductSortInput` | Specifies which attribute to sort on, and whether to return the results in ascending or descending order. [Queries]({{ page.baseurl }}/graphql/queries.html) describes sort orders.
