...
Magento has strengthened the hashing algorithms (SHA-256) used in password management. In addition, we added support for Argon2ID13, which is used by default if you have PHP 7.2 or you have installed the Libsodium extension for PHP.
