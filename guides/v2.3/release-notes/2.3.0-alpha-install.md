...
To minimize storage issues, only the latest three versions of Alpha packages will be available for download from repo.magento.com. This equates to the last three weeks of releases unless something gets disrupted.
