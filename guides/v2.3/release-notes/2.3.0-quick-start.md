...
Pre-release permission keys  are for Magento Commerce only. You do not need pre-release permission keys for the Open Source alpha package. But if you do not already have permission keys for the Commerce alpha package, contact Mark Brinton ([mbrinton@magento.com](mailto:mbrinton@magento.com)).
