...
We are pleased to present Magento Open Source 2.3.3.  This release includes over xxx functional fixes to the core product, over ### pull requests contributed by the community, and over 75 security enhancements.
