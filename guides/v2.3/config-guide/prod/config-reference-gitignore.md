...
If you looking for `.gitignore` file for Magneto Commerce Cloud project. Please see [Ignoring files section](https://devdocs.magento.com/guides/v2.3/cloud/project/project-start.html)