...
|:------- |:------ |:------ |:------ |
| `class` | Name of a class that implements rendering of a particular block. An object of this class is responsible for actual rendering of block output. | Fully qualified class name E.g. `Vendor\Module\Block\Class` | no |
...
| `template` | A template that represents the functionality of the block to which this attribute is assigned. | Vendor_Module::path/to/template.phtml (Scope is already in `templates` directory of module) | no |
