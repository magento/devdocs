...
* *Revertable data patch* - A patch that can be reverted as a module or path is uninstalled or deleted. Revertable operations are Data Query Language (DQL) and Data Modification Language (DML) operations: INSERT, UPDATE.
