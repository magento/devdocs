...
The message queue topology since 2.3 is a {{site.data.var.ce}} and {{site.data.var.ee}} feature. It can be included as part of an installation, or you can add it to existing modules.
...
See [Migrate message queue configuration]({{page.baseurl}}/extension-dev-guide/message-queues/queue-migration.html) for information about upgrading from Magento 2.0, 2.1 or 2.2.
