...
There is a way to hide it: employ autogenerated factory `YourClassName\ProxyDeferredFactory`. With its help, you can return values that seem like regular objects
