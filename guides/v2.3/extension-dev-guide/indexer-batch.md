...
Product EAV indexer is used in Magento only by MySQL search engine. Its indexation takes about 5 minutes on large Magento 2 Commerce performance profile. You can disable it to minimize indexation time.
