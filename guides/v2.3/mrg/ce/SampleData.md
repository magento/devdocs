...
## Documentation
You can find the more detailed description of sample data manipulation procedures at [http://devdocs.magento.com/guides/v2.0/install-gde/install/cli/install-cli-sample-data.html]({{ site.baseurl }}/guides/v2.0/install-gde/install/cli/install-cli-sample-data.html)
