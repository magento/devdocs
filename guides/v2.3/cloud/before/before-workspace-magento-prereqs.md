...
Install [PHP](https://glossary.magento.com/php) on your local machine. For information on installing PHP, see [PHP](../../../v2.3/install-gde/prereq/php-settings.html). For instructions for another OS, see the [PHP documentation](http://php.net/manual/en/install.php).
