...
The Admin and frontend UIs can be separated, because it's possible to have two different technology stacks. The Admin UI uses UI components, while the frontend UI can use the [PWA](http://pwastudio.io) studio stack, consisting of technology such as webpack, React, Redux, and GraphQL. 
