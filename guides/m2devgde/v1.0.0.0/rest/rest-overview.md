...
All REST calls for the Customer service are contained in the module's `webapi.xml`; however, inputs and return values are defined in their respective service interfaces.
...
In this example, the route url is `GET /V1/customerAccounts/:customerID/customer`
